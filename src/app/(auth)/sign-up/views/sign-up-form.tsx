    ...
    <div className={cn('flex flex-col gap-6', className)} {...props}>
      <Card>
        <CardHeader className='text-center'>
          ...
          <CardDescription>Create account with your Apple or Google account</CardDescription>
        </CardHeader>
        <CardContent>
          <>
            <div className='grid gap-6'>
              <div className='flex flex-col gap-4'>
                <Button variant='outline' className='flex w-full gap-4'>
              ...
              <form action={action} className='grid gap-4'>
                <div className='grid gap-2'>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <div>
                        <Input {...field} id='name' placeholder='Sam Smith' required />
                ...
                <div className='grid gap-2'>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <div>
                        <Input {...field} id='email' placeholder='sam@example.com' required />
